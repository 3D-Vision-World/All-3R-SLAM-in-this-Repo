...
- VGGT-Align: Bridging Local Reconstruction and Global Consistency for Long-Sequence 3D Reconstruction, *arXiv, 2026*. [[Paper](https://arxiv.org/pdf/2608.15260)] 
...
- Drone-Based Indoor Mapping for Augmented Indoor 3D Modeling Using Neural Simultaneous Localization And Mapping (SLAM), * IEEE International Conference on Consumer Electronics (ICCE) 2026*. [[Paper](https://ieeexplore.ieee.org/abstract/document/11449734/)]
